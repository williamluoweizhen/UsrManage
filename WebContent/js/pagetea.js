...
$(document).ready(function(){
	...
	$(".secdiv").mouseover(function(){
		$(this).find("div").css("color","#0e5e9b");
		$(this).find("div").find("img").css("display","block");
	});
	$(".secdiv").mouseout(function(){
		$(this).find("div").css("color","black");
		$(this).find("div").find("img").css("display","none");
	});
